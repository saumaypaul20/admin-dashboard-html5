function myFunction() {
    ...
    if (x.style.display === "none") {
        ...
        x.classList.remove("slideOutLeft");
        x.classList.add("slideInLeft");
        x.style.display = "block";
        
    } else {
        
        x.classList.remove("slideInLeft");
        x.classList.add("slideOutLeft");
...
if (x.style.display === "none") {
	...
	x.classList.remove("slideOutRight");
	x.classList.add("slideInRight");
	x.style.display = "block";
	// bounceIn
} else {
	
	x.classList.remove("slideInRight");
	x.classList.add("slideOutRight");
	x.style.display = "none";
